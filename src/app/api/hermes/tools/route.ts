      ...
      case "get_my_open_objectives": {
        ...
        const [collectionsResult, invoicesResult] = await Promise.all([
          supabase
            ...
            .select("id, lesson_cycle_id, status, cycle:academy_lesson_cycles!inner(period_start, status), reports:academy_lesson_report_revisions!academy_lesson_report_revisions_teacher_collection_id_fkey(id, revision, status, submitted_at)")
