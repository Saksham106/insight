...
PAYLOAD_GUIDANCE = (
    ...
    " Kitty Classes is separate from Academy sessions. Use preview_class before create_class. Both payloads require "
    "clientRequestId; use one stable value for the intended creation and reuse that exact clientRequestId for create_class or after an uncertain response. "
