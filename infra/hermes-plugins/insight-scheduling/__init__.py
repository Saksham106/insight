    ...
    ctx.register_tool(
        ...
        schema={
            ...
            "description": (
                ...
                "confirm_class_selection={occurrenceId,occurrenceVersion}. Only after that confirmation use its returned "
                "selectionToken. Attendance actions are record_class_attendance={occurrenceId,enrollmentId,status,estimatedAt?,"
                "note?,selectionToken,clientRequestId?} and correct_class_attendance={attendanceId,occurrenceId,enrollmentId,"
                "status,estimatedAt?,note?,selectionToken,clientRequestId?}. A bounded operational relay uses "
                "relay_class_update={occurrenceId,enrollmentId?,intent,estimatedAt?,mode?,locationLabel?,preparationCategory?,"
                "selectionToken,clientRequestId?}. A change request uses request_class_change={occurrenceId,occurrenceVersion,"
                "selectionToken,changeType,scope,enrollmentId?,proposedStartsAt?,proposedEndsAt?,proposedTimezone?,clientRequestId?}. "
